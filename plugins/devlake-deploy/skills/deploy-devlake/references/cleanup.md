...
- Key Vault
- Container Registry (if custom build)
- All associated resources

## Using the Cleanup Script

If you deployed using `deploy.ps1`, use the cleanup script:
...
If you deployed using `deploy.ps1`, a state file `.devlake-azure.json` was created in the current directory.
